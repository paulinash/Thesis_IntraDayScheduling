...
def get_gt_battery_evolution(model, pb_nom_gt):
    # gets a ground truth battery pb and calculates the battery state with the evolution equation
...
def get_ground_truth_pg_pb(model):
    # gets a model and returns the true pg and pb by using ground truth and model allocation
    ...
    # TODO weiß nicht ob e_nominal_gt hier überhuapt gebraucth wird
    # e_nominal_gt = get_gt_battery_evolution(model, pb_nom_gt)
